...
-- CreateIndex
CREATE INDEX "PlaylistItem_room_id_idx" ON "PlaylistItem"("room_id");
...
-- AddForeignKey
ALTER TABLE "PlaylistItem" ADD CONSTRAINT "PlaylistItem_room_id_fkey" FOREIGN KEY ("room_id") REFERENCES "Room"("id") ON DELETE CASCADE ON UPDATE CASCADE;
